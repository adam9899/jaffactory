...
public class JAFTreeConfiguration extends TreeConfiguration {
    public static final Codec<JAFTreeConfiguration> CODEC = RecordCodecBuilder.create((builder) -> {
        ...
        ).apply(builder, JAFTreeConfiguration::new);
    });
    ...
    protected JAFTreeConfiguration(BlockStateProvider trunkProvider, BlockStateProvider foliageProvider, BlockStateProvider altFoliageProvider, int minHeight, int maxHeight, List<TreeDecorator> decorators)
    {
    ...
    public static class Builder<T extends Builder>
    {
        ...
        public JAFTreeConfiguration build()
        {
            return new JAFTreeConfiguration(this.trunkProvider, this.foliageProvider, this.altFoliageProvider, this.minHeight, this.maxHeight, this.decorators);
        }
    }
}
