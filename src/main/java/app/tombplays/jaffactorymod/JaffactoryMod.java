package app.tombplays.jaffactorymod;
...
import app.tombplays.jaffactorymod.item.ModCreativeTabs;
import app.tombplays.jaffactorymod.item.ModItems;
import org.slf4j.Logger;

// The value here should match an entry in the META-INF/mods.toml file
@Mod(JaffactoryMod.MODID)
public class JaffactoryMod
{
    // Define mod id in a common place for everything to reference
    public static final String MODID = "jaffactory";
